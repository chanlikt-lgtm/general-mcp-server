"""Production entry point — runs the MCP server over streamable-http."""
...
mcp = FastMCP(
    ...
    instructions="General-purpose MCP server: database, files, web, math tools",
    host="0.0.0.0",
    port=8080,
)
...
if __name__ == "__main__":
    print("Starting MCP HTTP server on http://0.0.0.0:8080 ...")
